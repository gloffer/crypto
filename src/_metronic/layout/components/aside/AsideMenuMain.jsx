...
export function AsideMenuMain() {
  const intl = useIntl();
  return (<>
    <AsideMenuItem to='/trades' icon='/media/icons/duotune/arrows/arr007.svg' title='Trades' fontIcon='bi-app-indicator' />
    <AsideMenuItem to='/correlation' icon='/media/icons/duotune/abstract/abs017.svg' title='Correlation' fontIcon='bi-app-indicator' />
    <AsideMenuItem to='/coin-analysis' icon='/media/icons/duotune/files/fil003.svg' title='Coin analysis' fontIcon='bi-app-indicator' />
    {/* <AsideMenuItem to='/test' icon='/media/icons/duotune/art/art002.svg' title='Test' fontIcon='bi-app-indicator' /> */}
