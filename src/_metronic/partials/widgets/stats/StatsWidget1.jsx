...
const StatsWidget1 = ({ className, innerPadding = '' }) => {
    useEffect(() => {
        const element = document.getElementById('kt_stats_widget_1_chart');
        if (!element) {
            return;
        }
    ...
    return (<div className={`card ${className}`}>
      ...
      <div className='card-body pt-12'>
        {/* begin::Chart */}
        <div className='d-flex flex-center position-relative bgi-no-repeat bgi-size-contain bgi-position-x-center bgi-position-y-center h-175px' style={{
