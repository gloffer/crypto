...
const StatsWidget5 = ({ className, innerPadding = '' }) => {
    return (<div className={`card ${className}`}>
      ...
      <div className='card-body'>
        ...
        <div className='progress h-6px  bg-light-warning mt-7'>
          <div className='progress-bar bg-warning' role='progressbar' style={{ width: '60%' }} aria-valuenow={50} aria-valuemin={0} aria-valuemax={100}></div>
        </div>
        {/* end::Progress */}
      </div>
      {/* end::Body */}
