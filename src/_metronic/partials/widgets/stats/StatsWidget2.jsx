...
const StatsWidget2 = ({ className, innerPadding = '' }) => {
    ...
    const setTab = (tabNumber) => {
        ...
        const element = document.querySelector(`#tab${tabNumber}_chart`);
        if (!element) {
            return;
        }
          ...
          <div className='me-sm-10 me-0'>
            <ul className='nav flex-column nav-pills nav-pills-custom'>
              <li className='nav-item mb-3'>
                <a onClick={() => setTab(1)} className={`nav-link w-225px h-70px ${activeTab === '#tab1' ? 'active btn-active-light' : ''} fw-bolder me-2`} id='tab1'>
              ...
              <li className='nav-item mb-3'>
                <a id='tab2' className={`nav-link w-225px h-70px ${activeTab === '#tab2' ? 'active btn-active-light' : ''} fw-bolder me-2`} onClick={() => setTab(2)}>
                  <div className='nav-icon me-3'>
              ...
              <li className='nav-item mb-3'>
                <a id='tab3' className={`nav-link w-225px h-70px ${activeTab === '#tab3' ? 'active btn-active-light' : ''} fw-bolder me-2`} onClick={() => setTab(3)}>
                  <div className='nav-icon me-3'>
              ...
              <li className='nav-item mb-5'>
                <a id='tab4' className={`nav-link w-225px h-70px ${activeTab === '#tab4' ? 'active btn-active-light' : ''} fw-bolder me-2`} onClick={() => setTab(4)}>
                  <div className='nav-icon me-3'>
