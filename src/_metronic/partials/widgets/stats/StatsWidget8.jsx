...
const StatsWidget8 = ({ className, innerPadding = '' }) => {
    ...
    return (<div className={`card card-custom ${className}`}>
      ...
      <div className='card-footer border-0 pt-0 pb-10'>
        ...
        <div className='progress h-6px  bg-light-danger'>
          <div className='progress-bar bg-danger' role='progressbar' style={{ width: '70%' }} aria-valuenow={24} aria-valuemin={0} aria-valuemax={100}></div>
        </div>
        {/* end::Progress */}
      </div>
      {/* end::Footer */}
