...
const StatsWidget3 = ({ className, innerPadding = '' }) => {
    return (<div className={`card bg-danger ${className}`}>
      {/* begin::Body */}
      <div className={`card-body ${innerPadding}`}>
        ...
        <div className='progress h-6px mt-7 bg-white bg-opacity-10'>
          <div className='progress-bar bg-white' role='progressbar' style={{ width: '70%' }} aria-valuenow={50} aria-valuemin={0} aria-valuemax={100}></div>
        </div>
        {/* end::Progress */}
      </div>
      {/* end::Body */}
