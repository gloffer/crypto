...
const StatsWidget6 = ({ className, innerPadding = '', children }) => {
    return (<div className={`card ${className}`}>
      ...
      <div className={`card-body ${innerPadding}`}>
        ...
        <div className='d-flex bg-light-primary card-rounded flex-grow-1'>
          ...
          {/* begin::Pic */}
          <div className='position-relative bgi-no-repeat bgi-size-contain bgi-position-y-bottom bgi-position-x-end mt-6 flex-grow-1' style={{
