...
const StatsWidget4 = ({ className, innerPadding = '' }) => {
    return (<div className={`card ${className}`}>
      ...
      <div className={`card-body ${innerPadding}`}>
        ...
        <div className='progress h-6px  bg-light-success mt-7'>
          <div className='progress-bar bg-success' role='progressbar' style={{ width: '80%' }} aria-valuenow={50} aria-valuemin={0} aria-valuemax={100}></div>
        </div>
        {/* end::Progress */}
      </div>
      {/* end::Body */}
