...
const InboxCompose = ({ show, handleClose }) => {
    ...
    return (<Modal className='modal-sticky modal-sticky-lg modal-sticky-bottom-right' id='kt_inbox_compose' role='dialog' data-backdrop='false' aria-hidden='true' tabIndex='-1' show={show} animation={false}>
          ...
          <div className='d-block'>
            ...
            <div className='d-none align-items-center border-bottom inbox-to-cc ps-8 pe-5 min-h-45px'>
              ...
              <div className='flex-grow-1'>
                <input type='text' className='form-control border-0' name='compose_cc' value={composeCC} onChange={(e) => setComposeCC(e.target.value)}/>
              </div>
            ...
            <div className='d-none align-items-center border-bottom inbox-to-bcc ps-8 pe-5 min-h-45px'>
              ...
              <div className='flex-grow-1'>
                <input type='text' className='form-control border-0' name='compose_bcc' value={composeBCC} onChange={(e) => setComposeBCC(e.target.value)}/>
              </div>
            ...
            <div className='border-bottom'>
              <input className='form-control border-0 px-8 min-h-45px' name='compose_subject' placeholder='Subject' value={subject} onChange={(e) => setSubject(e.target.value)}/>
            </div>
            {/*end::Subject*/}
