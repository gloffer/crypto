...
export function SidebarUser() {
    ...
    return (<div id='kt_sidebar_content' className='py-10 px-2 px-lg-8'>
      <div className='hover-scroll-y me-lg-n5 pe-lg-4' data-kt-scroll='true' data-kt-scroll-height='auto' data-kt-scroll-offset='10px' data-kt-scroll-wrappers='#kt_sidebar_content'>
        {/* begin::Card */}
        <div className='card card-custom bg-info'>
          ...
          <div className='card-body px-0'>
            <div className='pt-0'>
              {/* begin::Chart */}
              <div className='d-flex flex-center position-relative bgi-no-repeat bgi-size-contain bgi-position-x-center bgi-position-y-center' style={{
