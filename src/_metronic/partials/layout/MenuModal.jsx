...
const MenuModal = ({ show, handleClose, children }) => {
    ...
    return (<Modal className='bg-white' id='kt_mega_menu_modal' aria-hidden='true' tabIndex='-1' dialogClassName='modal-fullscreen' contentClassName='shadow-none' show={show}>
                ...
                <div className='col-sm-4'>
                  <a href='#' className='card card-custom card-stretch mb-5 bg-light-info hoverable shadow-none min-h-250px'>
                    <div className='card-body d-flex flex-column p-0'>
                      ...
                      <div className='flex-grow-1 bgi-no-repeat bgi-size-contain bgi-position-x-center bgi-position-y-bottom card-rounded-bottom' style={{
