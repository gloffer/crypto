...
export function ExploreMain() {
    return (<>
      ...
      <div id='kt_explore' className='bg-body' data-kt-drawer='true' data-kt-drawer-name='explore' data-kt-drawer-activate='true' data-kt-drawer-overlay='true' data-kt-drawer-width="{default:'350px', 'lg': '475px'}" data-kt-drawer-direction='end' data-kt-drawer-toggle='#kt_explore_toggle' data-kt-drawer-close='#kt_explore_close'>
        {/* begin::Card  */}
                ...
                <div className='d-flex flex-stack'>
                  <div className='d-flex flex-column'>
                    <div className='d-flex align-items-center mb-1'>
                      ...
                      <i className='text-gray-400 fas fa-exclamation-circle ms-1 fs-7' data-bs-toggle='popover' data-bs-trigger='hover' data-bs-placement='top' data-bs-content='Use, by you or one client in a single end product which end users are not charged for.'></i>
                    </div>
                ...
                <div className='d-flex flex-stack'>
                  <div className='d-flex flex-column'>
                    <div className='d-flex align-items-center mb-1'>
                      ...
                      <i className='text-gray-400 fas fa-exclamation-circle ms-1 fs-7' data-bs-toggle='popover' data-bs-trigger='hover' data-bs-placement='top' data-bs-content='Use, by you or one client, in a single end product which end users can be charged for.'></i>
                    </div>
