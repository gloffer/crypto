...
export function Login() {
  ...
  return (<form className='form w-100' onSubmit={formik.handleSubmit} noValidate id='kt_login_signin_form'>
    ...
    <div className='text-center mb-10'>
      <h1 className='text-dark mb-3'>Sign In to Trading Bot</h1>
    ...
    </div>) : (<div className='mb-10 bg-light-info p-8 rounded'>
    ...
    <div className='fv-row mb-10'>
      ...
      <input placeholder='Email' {...formik.getFieldProps('email')} className={clsx('form-control form-control-lg form-control-solid', { 'is-invalid': formik.touched.email && formik.errors.email }, {
    ...
    <div className='fv-row mb-10'>
      ...
      <input type='password' autoComplete='off' {...formik.getFieldProps('password')} className={clsx('form-control form-control-lg form-control-solid', {
